...
const columns = [
  ...
  { id: "subCatName", label: "SUB CATEGORY NAME", minWidth: 0 },
    ...
    <>
      <div className="flex items-center justify-between px-2 py-0 mt-2 ">
        ...
        <div className="col flex items-center w-[25%] ml-auto gap-3 justify-end">
          <Button className="!py-3 !px-5 !text-[white] !bg-green-600 text-[13px] flex gap-x-2">
            <FaCloudArrowDown className="text-[30px]" />
            Export
          </Button>
          <Button
          ...
          >
            <GrAdd className="text-[20px]" /> Add New Sub Category
          </Button>
        </div>
      </div>
